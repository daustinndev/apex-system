                            ...
                            <FormLogin>
                                ...
                                <form onSubmit={handleSubmit}>
                                    <RowGrid>
                                        <ColumnGrid w='6'>
                                            <FormGroup>
                                                <FormControl name='firstName' id='name' onChange={handlerChange} onValue={userData.firstName} placeholderLabel='Nombres' required ></FormControl>
                                            </FormGroup>
                                        </ColumnGrid>
                                        <ColumnGrid w='6'>
                                            <FormGroup>
                                                <FormControl name='lastName' onChange={handlerChange} onValue={userData.lastName} placeholderLabel='Apellidos' required ></FormControl>
                                            </FormGroup>
                                        </ColumnGrid>
                                    </RowGrid>
                                    <RowGrid>
                                    ...
                                    <RowGrid>
                                        <ColumnGrid w='12'>
                                            <FormGroup>
                                                <FormControl name='password' onChange={handlerChange} onValue={userData.password} placeholderLabel='Contraseña nueva' required type='password'></FormControl>
                                            </FormGroup>
                                        </ColumnGrid>
                                    </RowGrid>
                                    <RowGrid>
                                        <ColumnGrid w='12'>
                                            <FormGroup>
                                                <ButtonPrimary loading={loadinglogin} ClasName='primary'>Registrarme</ButtonPrimary>
                                            </FormGroup>
                                        </ColumnGrid>
                                    </RowGrid>
                                </form>
                                ...
                                <RowGrid>
                                    <ColumnGrid w='12'>
                                        <FormGroup>
                                            <ButtonPrimary href='/sign-in' ColorText='var(--dodgerblue-300)' ClasName='default'>Iniciar Sesion</ButtonPrimary>
                                        </FormGroup>
                                    </ColumnGrid>
                                </RowGrid>
                                <RowGrid>
                                    <ColumnGrid w='12'>
                                        <FormGroup>
                                            <ButtonPrimary onClick={SignInGoogle} loading={loadingGoogle} ClasName='default' icon={faGoogle}>Registrarme con Google</ButtonPrimary>
                                        </FormGroup>
                                    </ColumnGrid>
                                </RowGrid>
                                <RowGrid>
